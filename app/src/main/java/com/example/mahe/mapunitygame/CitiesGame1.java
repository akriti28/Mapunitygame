...
public class CitiesGame1 extends AppCompatActivity {
    int i;
    int score=0;
    int flag=0;
       @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cities_game1);
        String next[] = {};
        ...
        try {
            reader = new CSVReader(new InputStreamReader(getAssets().open("citiesL1.csv")));
        } catch (IOException e) {
            e.printStackTrace();
        }
//in open();
           ...
           i = rand.nextInt(500) + 1;
           t1.setText(list1.get(i)[1]);
           t2.setText(list1.get(i)[2]);
               ...
               public void onClick(View v) {
                   ...
                   if (e1.getText().toString().equalsIgnoreCase(list1.get(i)[0].toString()))
                   {
                       ...
                       editor.putInt("scores1", score);
                       editor.commit();
                   }
                   else if (flag!=1 && e1.getText().toString().equalsIgnoreCase(list1.get(i)[4].toString()))
                   {
                       t0.setText("Correct country! The city is " +list1.get(i)[0].toString());
                       e1.setText("");
                       score=score+5;
                       sc.setText(String.valueOf(score));
                       SharedPreferences prefs1 = getSharedPreferences("myPrefs1", 0);
                   ...
                   {
                      if (flag==1) { flag=0; e1.setHint("Enter here"); }
                       t0.setText("Wrong! It's " + list1.get(i)[0].toString() + ", " + list1.get(i)[4].toString()); e1.setText("");
                     /*  score=score-5;
                       sc.setText(String.valueOf(score));
                       SharedPreferences prefs1 = getSharedPreferences("myPrefs1", 0);
                       SharedPreferences.Editor editor = prefs1.edit();
...
*/
           ...
           idk.setOnClickListener(new View.OnClickListener() {
               ...
               public void onClick(View v) {
                   ...
                   if (flag==1) { flag=0; e1.setHint("Enter here"); }
                 //  t0.setText("It's " + list1.get(i)[0].toString() + ", " + list1.get(i)[4].toString());
           ...
           hint.setOnClickListener(new View.OnClickListener() {
               ...
               public void onClick(View v) {
                   ...
                   t0.setText("It's in " + list1.get(i)[4].toString());
